...
<head>
    ...
    <link href="../../io.robe.admin-ui/js/bootstrap/bootstrap.orange.css" rel="stylesheet">
    <script type="text/javascript" charset="utf-8" src="../../io.robe.admin-ui/js/kendoui/js/jquery.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="../../io.robe.admin-ui/js/strength.js"></script>
    <script>
