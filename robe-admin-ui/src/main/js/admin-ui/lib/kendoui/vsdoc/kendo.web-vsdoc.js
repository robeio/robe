...
kendo.data.DataSource.prototype = {
    ...
    data: function (value) {
        /// <summary>
        /// Gets or sets the data items of the data source.If the data source is bound to a remote io.robe.admin (via the transport option) the data method will return the io.robe.admin response.
...
/// the data method will return the group items.
    ...
    fetch: function (callback) {
        /// <summary>
        /// Reads the data items from a remote io.robe.admin (if the transport option is set) or from a JavaScript array (if the data option is set).
        /// </summary>
    ...
    query: function (options) {
        /// <summary>
        /// Executes the specified query over the data items. Makes a HTTP request if bound to a remote io.robe.admin.
        /// </summary>
    ...
    read: function (data) {
        /// <summary>
        /// Reads data items from a remote io.robe.admin (if the transport option is set) or from a JavaScript array (if the data option is set).
        /// </summary>
        /// <param name="data" type="Object" >Optional data to pass to the remote io.robe.admin.</param>
    ...
    sync: function () {
        /// <summary>
        /// Saves any data item changes.The sync method will request the remote io.robe.admin if:
        /// </summary>
...
kendo.ui.DateTimePicker.prototype = {
    ...
    close: function (view) {
        ...
        /// </summary>
        /// <param name="io" type="String" >The io of the DateTimePicker, expressed as a string. Available io.robe.admin.views are "time" and "date".</param>
...
/// &#10;instance.If the dataSource option is set to a JavaScript object or array the widget will initialize a new kendo.data.SchedulerDataSource instance using that value as data source configuration.If the dataSource option is an existing kendo.data.SchedulerDataSource instance the widget will use that instance and will not initialize a new one.
    ...
    /// &#10;
    /// &#10;endTime — Date 
    /// &#10;The end time of the week and day io.robe.admin.views. The scheduler will display events ending before the endTime.
    /// &#10;
...
/// &#10;with a scheduler event.
    ...
    /// &#10;
    /// &#10;startTime — Date 
    /// &#10;The start time of the week and day io.robe.admin.views. The scheduler will display events starting after the startTime.
    /// &#10;
    /// &#10;timezone — String 
...
/// &#10;scheduler widget is bound to local array of events. It is advisable to specify a timezone if the scheduler is bound to a remote io.robe.admin.
/// &#10;That way all users would see the same dates and times no matter their configured system timezone.The complete list of the supported timezones is available in the List of IANA time zones Wikipedia page.
    /// &#10;
    /// &#10;io.robe.admin.views — Array
    /// &#10;The io.robe.admin.views displayed by the scheduler and their configuration. The array items can be either objects specifying the io configuration or strings representing the io types (assuming default configuration).
