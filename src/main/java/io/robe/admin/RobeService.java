...
/**
 * Default admin class of Robe.
 * If you extend this class on your applications admin class and call super methods at
...
public class RobeService extends Service<RobeServiceConfiguration> {
    ...
    public void initialize(Bootstrap<RobeServiceConfiguration> bootstrap) {
        ...
        HibernateManagableQuartzBundle quartzBundle = new HibernateManagableQuartzBundle(hibernateBundle);
