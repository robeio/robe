...
public class ListFilesUtilTest {
    ...
    public void listFilesAndFolders() throws Exception {
        ...
        assertEquals(0, ListFilesUtil.listFilesAndFolders("/test", null).size());
    }

    @Test
    public void listFiles() throws Exception {
        assertTrue(ListFilesUtil.listFiles("/").size() > 0);
        assertEquals(0, ListFilesUtil.listFiles("/test", null).size());
    }
    ...
    public void listFolders() throws Exception {
        ...
        assertTrue(ListFilesUtil.listFolders("/", "").size() > 0);
        assertEquals(0, ListFilesUtil.listFolders("/test", null).size());
    }
    ...
    public void listFilesAndFilesSubDirectories() throws Exception {
        ...
        assertEquals(0, ListFilesUtil.listFilesAndFilesSubDirectories("/test", null).size());
    }
    ...
    public void listFilesAndFilesSubDirectoriesByRegex() throws Exception {
        ...
        assertTrue(ListFilesUtil.listFilesAndFilesSubDirectoriesByRegex("/test", null).size() == 0);
    }
    ...
    public void listFilesAndDirectoriesTree() throws Exception {
        ...
        assertEquals(0, ListFilesUtil.listFilesAndDirectoriesTree("/test", null).size());
    }
    ...
    public void listFilesAndDirectoriesTreeByRegex() throws Exception {
        ...
        assertTrue(ListFilesUtil.listFilesAndDirectoriesTreeByRegex("/test", null).size() == 0);
    }
}
